...
int main(int argc, char **argv)
{
	...
	// Korus ver. topic
	ros::Publisher stopline_pub = nh1.advertise<std_msgs::Float64>("Vision/stopline", 100); //int형 메시지
	...
	VideoCapture cap1(cam_index); //전방 정면캠 
	// VideoCapture cap1("//home/kroad/stopline_video/0329/0329_5.mp4"); // INTEGRATED SUBJECT VER	
